    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <form action="page_ecom_product_add.php" method="post" class="form-horizontal form-bordered" onsubmit="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="product-name" name="product-name" class="form-control" placeholder="Enter product name.." required="required">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <div class="block-section">
                    ...
                    <form action="image/upload" class="dropzone"></form>
                </div>
