    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <form action="category/page_ecom_category_edit.php?<?=$_SERVER['QUERY_STRING']?>" method="post" class="form-horizontal form-bordered" onsubmit="">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            ...
                            <select id="category-category" name="category-category" class="select-chosen" data-placeholder="Choose Category.." style="width: 250px;">
                                ...
                                echo printMenuCategory('generateSelectMenuHTMLCategories',@$category['parent']);
                                ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <label class="switch switch-primary">
                                <input type="checkbox" id="category-status" name="category-status"<?=(@$category['display']==1 ? ' checked' : '')?>><span></span>
                            </label>
                        </div>
                    </div>
        ...
        <div class="col-lg-6">
            ...
            <div class="block">
                ...
                <div class="block-section">
                    ...
                    <form action="category/image/upload?<?=$_SERVER['QUERY_STRING']?>" class="dropzone"></form>
                </div>
                <?php } else { ?>
                <table class="table table-bordered table-striped table-vcenter">
                    <tbody>
                        <tr id="image-<?=$category['id']?>" data-id="<?=$category['id']?>">
                            <td style="width: 20%;">
                                <a href="" data-toggle="lightbox-image">
                                    <img src="<?=base_url().$category['image']?>" alt="" class="img-responsive center-block" style="max-width: 110px;">
                                </a>
                            </td>
                            <td class="text-center">
                                <a href="javascript:deleteImage(<?=$category['id']?>)" class="btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> Delete</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<script type="text/javascript">
    $(window).load(function () {
        ...
        $('input[name^=display-]').click(function(e) {
            ...
            console.log(display);
            $.post('category/image/update/'+id, {data:{display:+display}}, function(data) {
                //$('tr#image-'+id).hide();
                console.log(data);
            });
        });
