...
<link href="blog/rss/index/store_id/1/" title="Blog" rel="alternate" type="application/rss+xml" />
<!--[if lt IE 9]>
...
<script type="text/javascript">
//<![CDATA[
Mage.Cookies.path     = '/fgc/supermarket-MVC';
...
<script type="text/javascript"> Themecfg = {
	"general":{
		"enabled":"1",
		"jquery":"1",
		"ajaxloading":"<?=base_url()?>skin/frontend/alosupermarket/default/images/opc-ajax-loader.gif",
		"baseUrl":"<?=base_url()?>",
	},
	"home":"\n            ",
    ...
    //<![CDATA[
        ...
        MC.Quickview = {"dialogWidth":"800","zoomWidth":"265","zoomHeight":"265","vertical":"1"};
            jQuery(document).ready(function($) {
                jQuery(document).magiccart({
                	"url":"<?=base_url()?>magicshop/ajax/index/",
                	"updateUrl":"<?=base_url()?>checkout/cart/updatePost/",
                	"src_image_progress":"<?=base_url()?>skin/frontend/alosupermarket/default/magiccart/magicshop/images/loading.gif",
                	"error":" \u2191 This is a required field.","isProductView":0,
                });
            });
            //]]
</script>
