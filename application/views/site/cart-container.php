                        ...
                        <div class="row">
                                            ...
                                            <table id="shopping-cart-table" class="data-table cart-table">
                                                ...
                                                <thead class="hidden-phone">
                                                    <tr>
                                                        ...
                                                        <th rowspan="1" class="a-center last">Remove</th>
                                                    </tr>
                                                </thead>
                                                <tfoot>
                                                    <tr>
                            ...
                            <![endif]-->
                                                ...
                                                foreach ($cart as $id => $value) { ?>
                                                    <tr>
                                                        <td><a href="<?=$value['slug'] ?>.html" title="<?=$value['name'] ?>" class="product-image"><img src="<?=$value['thumbnail'] ?>" width="120" height="120" alt="<?=$value['name'] ?>" /></a></td>
                                                        <td>
                                                        ...
                                                        <td class="a-center">
                                                            <a class="btn-edit btn-edit2" href="checkout/cart/configure/id/2164/" title="Edit item parameters">Edit</a>
                                                        </td>


                                                        <td class="a-right">
                                                            <span class="data-cell-label">Unit Price</span>
                                                ...
                                                <span class="price">$<?=$value['price'] ?></span>
                                                        ...
                                                        <td class="a-center">
                                                            <span class="data-cell-label">Qty</span>
                                                            <div class="custom-qty clearfix">
                                                                <a class="alo_qty alo_qty_dec" href="javascript:void(0)"><i class="fa fa-caret-down"></i></a>
                                                                <input name="cart[<?=$id ?>][qty]" value="<?=$value['qty'] ?>" size="4" title="Qty" class="input-text qty" maxlength="12" />
                                                                <a class="alo_qty alo_qty_inc" href="javascript:void(0)"><i class="fa fa-caret-up"></i></a>
                                                            </div>
                                                        </td>

                                                        <!--Sub total starts here -->
                                                        <td class="a-right a-subtotal">
                                                            <span class="data-cell-label">Subtotal</span>
                                                            <span class="cart-price">
                                                ...
                                                <span class="price">$<?=$value['subtotal'] ?></span>
                                                        ...
                                                        <td class="a-center">
                                                            <span class="data-cell-label">Remove</span>
                                                            <a href="checkout/cart/delete/id/2164" title="Remove item" class="btn-remove btn-remove2"><i class="fa fa-times-circle icons"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php } ?>
                                                </tbody>
                                                        ...
                                                        <script type="text/javascript">
                                                            ...
                                                            new RegionUpdater('country', 'region', 'region_id', {
                                                                "config": {
                                                                    ...
                                                                    "regions_required": ["AT", "CA", "CH", "DE", "EE", "ES", "FI", "FR", "LT", "LV", "RO", "US"]
                                                                },
                                                                "ES": {
                                                                    "130": {
                                                                        "code": "A Coru\u0441a",
                                                                ...
                                                                <dd>
                                                                    <ul>
                                                                        <li>
                                                                            ...
                                                                            <label for="s_method_flatrate_flatrate">Fixed<span class="price">$15.00</span></label>
                                                                        </li>
                                                                    </ul>
                                                                </dd>
                                                            </dl>
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td style="" class="a-right">
                                                                    <strong><span class="price">$750.00</span></strong>
                                                                </td>
                                                            </tr>
                                                        </tfoot>
                                                        <tbody>
                                                            <tr>
                                                                <td style="" class="a-right" colspan="1">
                                                                    Subtotal </td>
                                                                <td style="" class="a-right">
                                                                    <span class="price">$750.00</span> </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                    <ul class="checkout-types">
                                                        ...
                                                        <li><a href="http://alothemes.com/demo/supermarket/index.php/checkout/multishipping/" title="Checkout with Multiple Addresses">Checkout with Multiple Addresses</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
