            ...
            <span class="vmagicmenu-subtitle">Categories</span>
                                                            ...
                                                            <div class="block-vmagicmenu-content">
                                                                <ul class="vmagicmenu-narrow clearfix">
                                                                    <li class="level0 cat first"><a class="level-top" href="http://alothemes.com/demo/supermarket/index.php/automovie-motorcyle.html"><img class="img-responsive" alt="Automovie & Motorcyle" src="media/catalog/category//06.png"><span>Automovie & Motorcyle</span><span class="boder-menu"></span></a></li>
                                                                    <li class="level0 cat  hasChild dropdown"><a class="level-top" href="http://alothemes.com/demo/supermarket/index.php/electronics.html"><img class="img-responsive" alt="Electronics" src="media/catalog/category//01.png"><span>Electronics</span><span class="boder-menu"></span></a>
                                                                        <ul class="level0">
