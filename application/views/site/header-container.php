                                                ...
                                                <div class="header-wrapper-bottom">
                                                    ...
                                                    <div class="custom-menu">
                                                                                                                ...
                                                                                                                <div class="per-product">
                                                                                                                    <div class="images-container">
                                                                                                                        <div class="product-hover">
                                                                                                                            ...
                                                                                                                            <a href="catalog/product/view/id/14/s/smart-tv-lc-50n6000u-new/category/261/" title="Smart TV LC-50N6000U New" class="product-image"><img class="img-responsive" src="http://alothemes.com/demo/supermarket/media/catalog/product/cache/1/small_image/235x270/9df78eab33525d08d6e5fb8d27136e95/1/0/10_1.jpg" width="235" height="270" alt="Smart TV LC-50N6000U New" />
                                                                                                                        ...
                                                                                                                        <div class="products-textlink clearfix">
                                                                                                                            ...
                                                                                                                            <div class="price-box">
                                                                                                                                <p class="old-price">
                                                                                                                                    ...
                                                                                                                                    <span class="price" id="old-price-14">$410.00</span>
                                                                                                                                </p>

                                                                                                                                <p class="special-price">
                                                                                                                                    <span class="price-label">Special Price</span>
                                                                                                                                    <span class="price" id="product-price-14">$290.00</span>
                                                                                                                                </p>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <div class="actions-no hover-box">
                                                                                                                            <div class="actions">
                                                                                                                                <div class="actions-cart">
                                                                                                                                    <button type="button" title="Add to Cart" class="button btn-cart pull-left-none" onclick="setLocation('checkout/cart/add/uenc/tbD9jb2xvcj01Jm1vZGU9bGlzdCZwcmljZT00MC0,/product/14/form_key/cPv7ZCDWDkada6aC/')"><span><span>Add to Cart</span></span></button>
                                                                                                                                </div>
                                                                                                                                <ul class="add-to-links pull-left-none"></ul>
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                </div>
                                                                ...
                                                                <li class='level0 ext  hasChild first'><span class="level-top"><span>Product Types<span class="cat_label Hot">Hot</span></span>
                                                                    ...
                                                                    <div class="level-top-mega">
                                                                        <ul class="level0 dropdown">
                                                                            <li class="level1"><a href="smart-tvs-from-sharpusa.html"><span>Mới nhất</span></a></li>
                                                                            <li class="level1"><a href="grouped-product.html"><span>Bán chạy nhất</span></a></li>
                                                                            <li class="level1"><a href="configurable-product.html"><span>Giảm giá đặc biệt</span></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </li>
                                                        ...
                                                        <div class="nav-mobile">
                                                            ...
                                                            <ul>
                                                                <?=printMenuCategory('generateMenuMobileHTMLCategories')?>
                                                                <li class='level0 ext  hasChild first'><span class="level-top"><span>Product Types<span class="cat_label Hot">Hot</span></span>
                                                                    </span>
                                                                    <!-- <div class="level-top-mega">
                                                                        <ul class="level0 dropdown">
                                                                ...
                                                                <li class='level0 ext'><a class="level-top" href="contacts/"><span>Contact Us</span></a></li>
                                                                <li class='level0 ext last'><a class="level-top" href="about/"><span>About Us</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
