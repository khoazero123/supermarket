                        ...
                        <div class="row">
                            <div class="col-main col-lg-12">
                                <div class="account-create">
                                    ...
                                    <form action="http://alothemes.com/demo/supermarket/index.php/customer/account/createpost/" method="post" id="form-validate">
                                        <div class="fieldset">
                                            <input type="hidden" name="success_url" value="" />
                                            <input type="hidden" name="error_url" value="" />
                                            <input type="hidden" name="form_key" value="IkRCx1boepCUnqIN" />
